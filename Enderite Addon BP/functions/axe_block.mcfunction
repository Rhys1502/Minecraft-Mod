...
fill ~~~ ~~~ stripped_crimson_hyphae 0 replace crimson_hyphae
fill ~~~ ~~~ stripped_crimson_stem 0 replace crimson_stem
fill ~~~ ~~~ stripped_mangrove_log 0 replace mangrove_log
fill ~~~ ~~~ stripped_mangrove_wood 0 replace mangrove_wood
...
fill ~~~ ~~~ stripped_warped_hyphae 0 replace warped_hyphae
fill ~~~ ~~~ stripped_warped_stem 0 replace warped_stem
